...
# Livermore-inspired AUTO + whisper exit guard — MEXC spot XLM/USDT only
...
parser.add_argument('--auto', action='store_true', help='Enable AUTO market sells (high risk — watch closely)')
